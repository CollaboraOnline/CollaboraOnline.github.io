...
title = "Pranam's launch.json"
description = "Pranam's launch.json"
tags = [
	"snippet",
	"ides",
    "VSCode",
    ...
    "configurations": [
        {
            ...
            "request": "launch",
            "name": "Writer",
            "url": "http://192.168.1.7:9980/browser/4bcba760d/debug.html?file_path=${workspaceFolder}/test/data/hello-world.odt",
        },
        {
            "type": "chrome",
            "request": "launch",
            "name": "Calc",
            "url": "http://192.168.1.7:9980/browser/4bcba760d/debug.html?file_path=${workspaceFolder}/test/data/hello-world.ods",
        },
        {
            "type": "chrome",
            "request": "launch",
            "name": "Impress",
            "url": "http://192.168.1.7:9980/browser/4bcba760d/debug.html?file_path=${workspaceFolder}/test/data/hello-world.odp",
        },
        {
            "type": "chrome",
            "request": "launch",
            "name": "Draw",
            "url": "http://192.168.1.7:9980/browser/4bcba760d/debug.html?file_path=${workspaceFolder}/test/data/hello-world.odg",
        },
        {
            "type": "chrome",
            "request": "launch",
