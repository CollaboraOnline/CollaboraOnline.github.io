...
## Build
Use a separate “online” checkout — not the one you use for regular Online builds. Clone the LibreOffice core repository and switch to the coda-25.04 branch.  [For general build guidance, see the normal build instruction](/post/build-code/).
